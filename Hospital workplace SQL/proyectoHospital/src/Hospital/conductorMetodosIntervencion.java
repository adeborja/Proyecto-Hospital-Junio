...
public class conductorMetodosIntervencion {
	public static void main(String[] args){
		...
		//PINTAR INTERVENCIONES DE PACIENTE
		consultor.pintarIntervencionesDePaciente(13);
		
		//PINTAR INTERVENCIONES DE MEDICO
		consultor.pintarIntervencionesDeMedico(945765);
